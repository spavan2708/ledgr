...
export interface SessionContext { profile_input: FinancialProfile | null; profile_analysis: FinancialProfileResult | null; declared_monthly_capacity: number | null; goals: GoalInput[]; goal_simulation: GoalSimulationResponse | null; }
